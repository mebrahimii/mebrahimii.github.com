...
--
-- Host: 127.0.0.1    Database: DBSQLPractice
-- ------------------------------------------------------
...
--
-- Create new databse `DBSQLPractice`
--

DROP SCHEMA IF EXISTS `DBSQLPractice`;
CREATE SCHEMA `DBSQLPractice`;
USE `DBSQLPractice`;
...
-- Dump completed on 2020-03-17 15:02:16
